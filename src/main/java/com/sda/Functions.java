...
//ctrl W - <-- -->
        ...
        Stream.of(key, "other string", "ala", "ma", "kota")
                .map(String::length) //metoda referencyjna - gdy mamy jeden argument - tutaj tylko jeden string
                .forEach(System.out::println);

        Stream.of(key, "other string", "ala", "ma", "kota")
                .map(s -> s.length()) //funkcja anonimowa
                .forEach(System.out::println);
